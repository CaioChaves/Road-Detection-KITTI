...
# -*- coding: utf-8 -*-
"""
Created on Wed May 29 11:05:27 2019
...
def main():
    ...
    train_set = torchvision.datasets.cityscapes.Cityscapes(
    ...
    # Test set
    test_set = torchvision.datasets.cityscapes.Cityscapes(
            root = './data/cityscapes',
            split ='val',
            mode='coarse',
            target_type='semantic',
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        lossEpochTest = test(args, myNetwork, device, test_loader)
